...
| 3×3双边滤波(自实现) | <img src="D:\浙江大学\课程\2022春夏课程\数字图像处理与机器视觉\CVprojects\Project3\report\img_bf_guass.jpg" alt="img_bf_guass" style="zoom:80%;" /> | <img src="D:\浙江大学\课程\2022春夏课程\数字图像处理与机器视觉\CVprojects\Project3\report\img_bf_SP.jpg" alt="img_bf_SP" style="zoom:80%;" /> |
| 3×3双边滤波(openCV) | <img src="D:\浙江大学\课程\2022春夏课程\数字图像处理与机器视觉\CVprojects\Project3\report\img_bf_guass_cv.jpg" alt="img_bf_guass_cv" style="zoom:80%;" /> | <img src="D:\浙江大学\课程\2022春夏课程\数字图像处理与机器视觉\CVprojects\Project3\report\img_bf_SP_cv.jpg" alt="img_bf_SP_cv" style="zoom:80%;" /> |
...
​		从图中可以看到，均值滤波对高斯噪声和椒盐噪声均有一定程度的抑制，但不能完全去除，且对椒盐噪声的去除程度要显著小于高斯噪声。与此同时，均值滤波不能很好地保护图像细节，在给图像去噪的同时也破坏了图像细节部分，丢失图像特征信息，使图像变得模糊。
...
​		从图中可以看到，中值滤波对高斯噪声和椒盐噪声均有较大程度的抑制，但不能完全去除，且对椒盐噪声的去除程度要略小于高斯噪声。处理后图像的模糊程度相比均值滤波有所改善，但涂抹感（油画感）较为严重。
